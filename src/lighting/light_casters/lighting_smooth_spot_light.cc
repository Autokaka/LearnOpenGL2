...
class MyApp final : public App, AppDelegate {
  ...
  void DrawContent() override {
    ...
    {  // draw lighted entity
      device_->UseProgram(lighted_shader_);
      {
        ...
        lighted_shader_->SetFloat("u_light.inner_cut_off",
                                  glm::cos(glm::radians(light_.inner_cut_off)));
        lighted_shader_->SetFloat("u_light.outer_cut_off",
                                  glm::cos(glm::radians(light_.outer_cut_off)));
 ...
 private:
  ...
  void DrawUI() {
    ...
    ImGui::SliderFloat("light.inner_cut_off", &light_.inner_cut_off, 0.0f,
                       90.0f);
    ImGui::SliderFloat("light.outer_cut_off", &light_.outer_cut_off, 0.0f,
                       90.0f);
