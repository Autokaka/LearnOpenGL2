...
int main() {
  ...
  // clang-format off
  float vertices[] = {
    /** layout location(0) vec3 aPos -> */ -0.5f, -0.5f, 0.0f, /** layout location(1) vec4 aColor -> */ 0.0f, 1.0f, 0.0f, 1.0f,
    /** layout location(0) vec3 aPos -> */ 0.0f, 0.5f, 0.0f, /** layout location(1) vec4 aColor -> */ 0.0f, 0.0f, 1.0f, 1.0f,
    /** layout location(0) vec3 aPos -> */ 0.5f, -0.5f, 0.0f, /** layout location(1) vec4 aColor -> */ 1.0f, 0.0f, 0.0f, 1.0f
  };
  // clang-format on
  uint VBO;
  glGenBuffers(1, &VBO);
...
void main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    int changingColorLocation =
        glGetUniformLocation(shaderProgram, "changingColor");
    glUniform4f(1, 0.0f, greenValue, 0.0f, 1.0f);
