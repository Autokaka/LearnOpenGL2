...
vec4 GetSpecularLightColor() {
  ...
  vec4 texture_color = texture(u_material.specular, v_tex_coord);
  texture_color.r = 1 - texture_color.r;
  texture_color.g = 1 - texture_color.g;
  texture_color.b = 1 - texture_color.b;
  return texture_color * specular * u_light.specular;
}
