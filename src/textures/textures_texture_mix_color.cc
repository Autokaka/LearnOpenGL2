...
int main() {
  ...
  // clang-format off
  float vertices[] = {
    /** layout location(0) vec3 aPos */ -0.5f, -0.5f, 0.0f, /** layout location(1) vec3 aTexCoord */ 0.0f, 0.0f, /** layout location(2) vec3 aColor */ 1.0f, 0.0f, 0.0f,
    /** layout location(0) vec3 aPos */ -0.5f, 0.5f, 0.0f, /** layout location(1) vec3 aTexCoord */ 0.0f, 1.0f, /** layout location(2) vec3 aColor */ 0.0f, 1.0f, 0.0f,
    /** layout location(0) vec3 aPos */ 0.5f, 0.5f, 0.0f, /** layout location(1) vec3 aTexCoord */ 1.0f, 1.0f, /** layout location(2) vec3 aColor */ 0.0f, 0.0f, 1.0f,
    /** layout location(0) vec3 aPos */ 0.5f, -0.5f, 0.0f, /** layout location(1) vec3 aTexCoord */ 1.0f, 0.0f, /** layout location(2) vec3 aColor */ 1.0f, 1.0f, 0.0f,
  };
  // clang-format on
  uint VBO;
  glGenBuffers(1, &VBO);
